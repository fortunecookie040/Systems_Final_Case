...
2) System Overview
Course Concept(s):
In this project, we used a Flask API, a virtual environment, logging/metric, and azure deployment.
...
We chose this concept of Flask API and azure deployment because we thought it was the most applicable to future projects, especially in hackathons and such where we have to deploy an app. We thought this was a good way to recall what we learned in our case studies and apply it. We also thought that this was easier to understand than tinyllama and such. Thus, when we used github and azure, we felt like we could understand how to do so. We originally wanted to do a gpt, however, We think we need a little more practice with that since we had a lot of trouble making it work when doing the case study. 
